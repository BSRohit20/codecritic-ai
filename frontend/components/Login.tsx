...
export default function Login({ onSwitchToRegister }: LoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await login(email, password, 'dummy-captcha-token');
    } catch (err: any) {
        ...
        <div className="relative z-10 text-center max-w-xl">
            ...
            <div className="group hover:scale-105 transition-transform duration-300">
              <div className="flex flex-col items-center text-center gap-4 p-6 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 backdrop-blur-sm rounded-2xl border border-blue-500/20">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-lg">Get instant feedback with advanced AI detecting bugs, security issues, and performance bottlenecks.</p>
                </div>
              </div>
            </div>
            ...
            <div className="group hover:scale-105 transition-transform duration-300">
              <div className="flex flex-col items-center text-center gap-4 p-6 bg-gradient-to-r from-cyan-500/10 to-sky-500/10 backdrop-blur-sm rounded-2xl border border-cyan-500/20">
                ...
                <div>
                  ...
                  <p className="text-blue-100 text-lg">Support for JavaScript, Python, TypeScript, Java, C++, Rust, and many more.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 flex justify-center items-center gap-2">
            ...
            <p className="text-blue-200 text-sm font-medium">
              Trusted by <span className="text-white font-bold">10,000+</span> developers worldwide
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-4 sm:p-6">
        <div className="max-w-md w-full space-y-6 relative z-10">
          ...
          <div className="text-center">
            ...
            <p className="text-blue-300 text-lg">Sign in to continue your journey</p>
          </div>
